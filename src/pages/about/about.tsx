...
const aboutItems: AboutItem[] = [
  {
    ...
    subContent:"Samadhan AIs eliminates this by utilizing the predominantory source of information, the user’s resume. We use Convex to analyze the resume and provide a seamless experience for the users aka you to find the right job or the right candidate.",
      position: "left",
    image: one,
  },
  {
    title: "How it works?",
    content:
      "As Job seekers/Candidates you can submit your resumes to Samadhan AIs, and we tokenise and store it in our database. As a recruiter, you can search for your ideal candidate by listing the relevant keywords and skills that you are looking for.",
  ...
  },
  {
    ...
    content:
      "Convex sits at the forefront of Samadhan AIs. our system stores the resumes in the object storage provided by Convex and utilizes Convex-Langchain to tokenize the resume. Utilizing Vector Search provided by Convex enables recruiters to be matched with the most eligible candidates.",
  ...
  {
    title: "What's next?",
    subheading: "We have a lot going forward for the future of Samadhan AIs!",
  ...
  return (
    <>
      ...
      <div className="text-white">
        <h2 className="m-16 text-center text-4xl ">About <span className="text-primary-foreground text-4xl font-bold">Samadhan AIs</span> and the use of <span className="text-primary-foreground text-4xl font-bold">Convex</span></h2>
